...
# --- CSS STYLING (Prémiový kovářský vizuál s autentickým podpisovým fontem) ---
st.markdown("""
<style>
/* Import nových uměleckých a podpisových fontů (Alex Brush, Satisfy, Caveat) */
@import url('https://fonts.googleapis.com/css2?family=Alex+Brush&family=Satisfy&family=Caveat:wght@700&family=Inter:wght@400;500;600&display=swap');
...
/* Aplikace dynamického podpisového fontu 'Alex Brush' na nadpisy */
/* TIP: Pokud chcete změnit barvu na bílou, přepište níže #c5a059 na #ffffff */
h1, h2, h3, h4 { 
...
/* Náhradní textové logo v menu, pokud chybí obrázek - stylováno jako podpis */
.sidebar-logo-text { 
    font-family: 'Alex Brush', cursive !important; 
    font-size: 2.5rem; 
    font-weight: 400; 
